...
export const Information = () => {
  ...
  return (
    <div className='bg-gray-200 w-screen flex justify-center min-h-max pt-4 font-main' id='home'>
      <div className='flex justify-center rounded-3xl relative'>
        <img className='w-11/12 rounded-3xl' src={Main} alt="Refugios" />
        <div className='absolute w-11/12 left-1/2 transform -translate-x-1/2 inset-0 bg-gradient-to-r from-secondary via-yellow-500/75 to-transparent rounded-3xl'></div>
        <div className="absolute inset-y-0 left-16 flex flex-col justify-center items-start gap-y-12 text-white">
          <h1 className="text-3xl">Bienvenido a esta página dedicada <br />a los refugios de animales. </h1>
